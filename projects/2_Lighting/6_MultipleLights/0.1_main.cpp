...
int main() {
    ...
    Shader lightingShader("0.6_shader_0.vs", "0.6_shader_0.fs");
    Shader lightCubeShader("0.6_shader_1.vs", "0.6_shader_1.fs");
    ...
    // load textures
    // We now use a utility function to keep the code more organized
